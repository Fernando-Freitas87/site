...
const WeatherSnap = () => {
    const [temperature] = React.useState(N.rand(28, 35));
...
const Pin = () => {
    ...
    return (React.createElement("div", { id: "app-pin-wrapper" },
        ...
        React.createElement("div", { id: "app-pin", onClick: handleOnClick },
            ...
            React.createElement("div", { className: "pin-group" }),
...
const Weather = () => {
            ...
            return (React.createElement("div", { key: day.id, className: "day-card" },
                React.createElement("div", { className: "day-card-content" },
                    React.createElement("span", { className: "day-weather-temperature" },
                        day.temperature,
                        React.createElement("span", { className: "day-weather-temperature-unit" },)),
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "O que temos essa semana ?" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-rectangles-mixed", id: "tools-section", title: "TAMBEM NAO DEFENI AINDA!" }, getTools()));
};
const Restaurants = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-lightbulb", id: "restaurants-section", title: "NAO DEFINI AINDA!" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-battery-bolt", id: "movies-section", scrollable: true, title: "VOU DEFINIR AMANHA!" }, getMovies()));
};
